package src.task24.task2413;

/**
 * Class for game's ball
 */
public class Ball extends BaseObject {
    ...
    //теукущее значение вектора движения(dx, dy)
    private double dx;
    private double dy;
     ...
     * Так и подход удобно использовать при отскоках от стен.
     */
